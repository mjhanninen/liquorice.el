;;; vanilla-theme.el -- a light contrasty color theme for Emacs
...
;;; NOTE: This theme is work-in-progress; it should be usable but there are
;;; still some rough corners.
...
(defun liquorice-test-vanilla-theme ()
  (interactive)
  (apply #'custom-set-faces
         (liquorice-desc-to-face-specs
          (liquorice-build-vanilla-desc))))

(deftheme vanilla
  "A light color theme with some contrast and conservative palette.")
